...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/bardaki/cosmos-sdk-ka v0.45.9-kava.4-ca-ca15
	// See https://github.com/cosmos/cosmos-sdk/pull/10401, https://github.com/cosmos/cosmos-sdk/commit/0592ba6158cd0bf49d894be1cef4faeec59e8320
	github.com/gin-gonic/gin => github.com/gin-gonic/gin v1.7.0
	// Use the cosmos modified protobufs
	github.com/gogo/protobuf => github.com/regen-network/protobuf v1.3.3-alpha.regen.1
	// Use custom tendermint - custom
	github.com/tendermint/tendermint => github.com/bardaki/tendermint v0.34.24-c10
	// Use rocksdb 7.1.2
	github.com/tendermint/tm-db => github.com/kava-labs/tm-db v0.6.7-kava.1
	// Use ethermint fork that respects min-gas-price with NoBaseFee true and london enabled, and includes eip712 support
	github.com/tharsis/ethermint => github.com/bardaki/ethermint v0.14.0-kava-v20.1-c1
